...
export class DeleteService {
  ...
  async deleteAll() {
    const query = `TRUNCATE TABLE public."users", public.blogs,  public.posts, public."postsLikeStatus", public."commentsPosts", public."commentsLikeStatus", public."confirmationEmailUsers", public."recoveryCodes", public."oldRefreshTokens", public."deviceSessions" RESTART IDENTITY CASCADE;`;
